...
{/* 
  Pure component::: 
  setTimeout => rendering. i happens in blind way. Some of the updates are not
  neede, and pure components come to fix it. 2 ways to do It:
  1. Just before componenent renders we have a hook ShouldComponentUpdate, 
     there we can make desicion to make update or not based on the state values.
